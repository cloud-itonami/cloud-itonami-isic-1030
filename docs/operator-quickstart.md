# Operator Quickstart — Community Fruit & Vegetable Processing

Shortest path from clone to a verified local dry-run for **ISIC 1030** (`cloud-itonami-isic-1030`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1030.git
cd cloud-itonami-isic-1030
```
...
- Blueprint governor key: `fruit-vegetable-processing-governor`
- Likely source path: `fruitprocessing.governor.cljc`
